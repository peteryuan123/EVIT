...
namespace CannyEVIT
{
    ...
    public:
        ...
        inline Eigen::Matrix<double, 3, 4> getProjectionMatrix()
        {
            return P_;
        }
        ...
        inline Eigen::Matrix3d Rbc()
        {
            return Tbc_.block<3, 3>(0, 0);
        }

        inline Eigen::Vector3d tbc()
        {
            return Tbc_.block<3, 1>(0, 3);
        }

        inline Eigen::Matrix4d Tbc()
        {
            return Tbc_;
        }

        inline Eigen::Matrix3d Rcb()
        {
            return Tcb_.block<3, 3>(0, 0);
        }

        inline Eigen::Vector3d tcb()
        {
            return Tcb_.block<3, 1>(0, 3);
        }

        inline Eigen::Matrix4d Tcb()
        {
            return Tcb_;
        }
