...
IMUFactor::IMUFactor(CannyEVIT::IntegrationBase *_pre_integration) : pre_integration(_pre_integration) {}
  ...
  if (jacobians) {
    ...
    if (jacobians[0]) {
      ...
      jacobian_pose_i.block<3, 3>(O_V, O_R) =
          Utility::skewSymmetric(Qi.inverse() * (IntegrationBase::G * sum_dt + Vj - Vi));
